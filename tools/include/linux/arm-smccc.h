...
#define ARM_SMCCC_VENDOR_HYP_KVM_PTP_FUNC_ID                      \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, \
			   ARM_SMCCC_OWNER_VENDOR_HYP, ARM_SMCCC_KVM_FUNC_PTP)
...
#define ARM_SMCCC_HV_PV_TIME_FEATURES                             \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_64, \
			   ARM_SMCCC_OWNER_STANDARD_HYP, 0x20)

#define ARM_SMCCC_HV_PV_TIME_ST                                   \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_64, \
			   ARM_SMCCC_OWNER_STANDARD_HYP, 0x21)

/* TRNG entropy source calls (defined by ARM DEN0098) */
#define ARM_SMCCC_TRNG_VERSION                                    \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, \
			   ARM_SMCCC_OWNER_STANDARD, 0x50)

#define ARM_SMCCC_TRNG_FEATURES                                   \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, \
			   ARM_SMCCC_OWNER_STANDARD, 0x51)

#define ARM_SMCCC_TRNG_GET_UUID                                   \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, \
			   ARM_SMCCC_OWNER_STANDARD, 0x52)

#define ARM_SMCCC_TRNG_RND32                                      \
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL, ARM_SMCCC_SMC_32, \
			   ARM_SMCCC_OWNER_STANDARD, 0x53)
